...
/* Register Space */
unsigned *nvc_get_regspace_extdev() { return nv_card.PEXTDEV; }
unsigned *nvc_get_regspace_fb() { return nv_card.PFB; }
unsigned *nvc_get_regspace_mc() { return nv_card.PMC; }
unsigned *nvc_get_regspace_ramdac() { return nv_card.PRAMDAC; }
